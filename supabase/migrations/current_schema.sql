...
CREATE TABLE public.assignments (
  ...
  description text,
  assignment_type character varying NOT NULL CHECK (assignment_type::text = ANY (ARRAY['quiz'::character varying::text, 'test'::character varying::text, 'assignment'::character varying::text, 'project'::character varying::text])),
